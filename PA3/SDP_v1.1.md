...
| S3-AI-05 | AI-01, AI-02 | Create a small proof-of-concept or mock evaluation for both proposed AI features. | Duy Anh | Triệu | 8h | S3-AI-02, S3-AI-03 | POC output, test queries, limitations, and recommendation are recorded. | Planned |
...
| S4-FIN-02 | FR23-FR24 | Implement debt summary, overdue processing, reminders, and revenue report data. | Duy Anh | Triệu | 8h | Overdue invoices and reminders are generated according to the documented rule. | Planned |
...
| S4-NOT-01 | ST25-ST26 | Integrate notifications and message-center updates for important events. | Duy Anh | Triệu | 6h | Relevant status changes create the documented notification. | Planned |
| S4-AI-01 | AI-01 | Build a labeled maintenance-ticket evaluation set and measure category, priority, and routing performance. | Đạt | Triệu | 6h | Evaluation results and known failure cases are documented. | Planned |
...
| S4-INT-01 | All operational groups | Integrate finance, residence, conduct, maintenance, and notification workflows. | Triệu | Đạt | 8h | Regression smoke tests pass across the integrated modules. | Planned |
...
| S5-SEC-01 | Run authentication, authorization, input-validation, and secret-management checks. | Đạt | Triệu | 8h | No critical unauthorized-access path remains open. | Planned |
| S5-PERF-01 | Run basic performance checks for key APIs and dashboards. | Triệu | Duy Anh | 5h | Results are recorded against the documented targets. | Planned |
...
| S5-DEP-01 | Rehearse deployment and application-environment recovery. | Duy Anh | Triệu | 5h | The application can be deployed using documented steps. | Planned |
...
> _Performed by:_ Đào Duy Anh | _Reviewed by:_ Tô Trần Hoàng Triệu | _Edited by:_ Trần Huỳnh Mạnh Đạt
...
- [ ] The final folder is named `PA3-Group[GroupId]`.
